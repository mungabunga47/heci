document.addEventListener('DOMContentLoaded', function() {
  const td = document.querySelector('td[background="col8english.jpg"]');
  if (!td) return;
  ...
  container.style.backgroundImage = 'url(col8english.jpg)';
  ...
  container.addEventListener('click', function(e) {
    ...
    if (Math.abs(x - centerX) <= scaleSettings.size/2 && 
      ...
      new Audio('ding.mp3').play().catch(e => console.log("No Sound play:", e));
    }
  });
